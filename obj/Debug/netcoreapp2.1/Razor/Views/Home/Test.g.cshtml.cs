#pragma checksum "C:\Users\Thomas\Desktop\Stuff\Products\product-viewer\Views\Home\Test.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6467117d36f12c4889407abec14e0a3e2c9d23ac"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6467117d36f12c4889407abec14e0a3e2c9d23ac", @"/Views/Home/Test.cshtml")]
    ...
    const Product = { 
     ...
     ");
                        ...
                        <div v-for=""feature in product.productFeatures.slice((i - 1) * 3, i * 3)"" class=""col-sm-4"">
                            <div class=""card w-100 product-card"">
                                ...
                                <div class=""card-body"">
                                    ...
                                    <button v-on:click=");
                WriteLiteral(@"""deleteFeature(feature.id)"">Delete</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class=""col-sm-4"">
                        <div class=""card w-100 product-card"" v-if=""!addingFeature"">
                            ...
                            <div class=""card-body"">
                                <h5 class=""card-title"">Add A New Feature</h5>
                                <p class=""");
                WriteLiteral(@"card-text"" v-on:click=""addFeature()"">Click Here</p>
                            </div>
                        </div>
                        <div class=""card w-100 product-card"" v-else>
                            <img class=""card-img-top"" src=""https://picsum.photos/200/100/?random"" alt=""Card image cap"">
        ...
        mounted() {
            ...
            axios
                ");
                WriteLiteral(@".get('/api/products/' + self.id + '?includeFeatures=true')
                .then(response => {
        ...
        methods: {
            ...
            submitFeature: function() {
                var self = this;
              ");
                WriteLiteral(@"  axios.post('/api/products/' + this.id + '/productFeatures', {
                    ""name"":self.newName,
