#pragma checksum "C:\Users\Thomas\Desktop\Stuff\Products\product-viewer\Views\Home\Test.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "38946e7cbb35d7e67be39b32881edc8109c9656a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"38946e7cbb35d7e67be39b32881edc8109c9656a", @"/Views/Home/Test.cshtml")]
...
const Bar = { 
    ...
    template: `<div><router-link to=""/"">Back to list</router-link><div clas");
                WriteLiteral(@"s=""loading"" v-if=""loading"">Loading
                    </div><div v-if=""product"">{{product.name}}</div></div>`,
     mounted() {
            var self = this
