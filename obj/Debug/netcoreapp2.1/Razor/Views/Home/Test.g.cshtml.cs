#pragma checksum "C:\Users\Thomas\Desktop\Stuff\Products\product-viewer\Views\Home\Test.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7c82d16b01647bab7600fd356ad07f7b11bef742"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7c82d16b01647bab7600fd356ad07f7b11bef742", @"/Views/Home/Test.cshtml")]
...
const Bar = { 
    ...
    `<div>
        <div class=");
                WriteLiteral(@"""loading"" v-if=""loading"">
            Loading...
        </div>
        <div v-if=""product"">
            <h1>{{product.name}}</h1>
            ...
            <div v-if=""product.productFeatures.length > 0"">
                <div v-for=""feature in product.productFeatures"">
                    ...
                    <div v-on:click=""deleteFeature(feature.id)"">Delete Feature</div>
                </div>
            </div>
        </div>
        <div v-on:click=""addFeature()"" v-if=""!addingFeature"">Add Feature</div>
        <div v-else>
            <input v-model=""newName"" placeholder=""edit me"">
        <input v-model=""newDescription"" placeholder=""edit me"">
        <button v-on:click=""submitFeature()"">Submit</button></div>
     ...
     mounted() {
           ...
           ");
                WriteLiteral(@" console.log(self.id);
            axios
...
axios.post('/api/products/' + this.id + '/productFeatures', {
    ...
    s");
                WriteLiteral(@"elf.product.productFeatures.push(response.data);
    console.log(response);
});
        }
    }
