#pragma checksum "C:\Users\Thomas\Desktop\Stuff\Products\product-viewer\Views\Home\Test.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9949e733583468d3190b268e166ab8e8a93d79ab"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9949e733583468d3190b268e166ab8e8a93d79ab", @"/Views/Home/Test.cshtml")]
        ...
        <div v-if=""product"">
            ...
            <div v-if=""product.productFeatures.length > 0"">
                <div v-for=""i in Math.ceil((product.productFeatures.length + 1) / 3)"" class=""row product-row"">
                    ...
                    <div v-if=""i == Math.ceil((product.p");
                WriteLiteral(@"roductFeatures.length + 1) / 3)"" class=""col-sm-4"">
                        ...
                        <div class=""card w-100 product-card"" v-else>
                            ...
                            <div class=""card-body"">
                                ...
                                <p class=""card-text"" click=""addFeature()"">Description: <input v-model=""newDescri");
                WriteLiteral(@"ption"" placeholder=""edit me""></p>
